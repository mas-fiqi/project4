...
const App = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.infoText}>
        Free Fire adalah game battle royale di mana 50 pemain bertarung untuk menjadi yang terakhir bertahan hidup. Pemain mendarat di pulau, mencari senjata dan peralatan, serta berusaha untuk bertahan hidup sambil mengalahkan pemain lain.!
        </Text>
        <Text style={styles.sectionTitle}>Download Free Fire: Bang Bang</Text>
