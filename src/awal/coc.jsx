  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Image source={{ uri: 'https://wallpapers.com/images/high/clash_of_-clans_-clan_-connection_-logo-hr1ps7jjcz7g7ygy-2.png' }} style={styles.logo} />
      ...
      <View style={styles.imageContainer}>
        <Image source={{ uri: 'https://wallpapers.com/images/high/clash_of_-clans_-clan_-connection_-logo-hr1ps7jjcz7g7ygy-2.png' }} style={styles.banner} />
      </View>
      ...
      <View style={styles.section}>
        <Text style={styles.infoText}>
          Clash of Clans adalah game strategi di mana pemain membangun desa, melatih pasukan, dan berencana untuk menyerang desa-desa pemain lain untuk mencuri sumber daya. Pemain juga dapat membentuk atau bergabung dengan klan untuk mendapatkan dukungan.!
        </Text>
